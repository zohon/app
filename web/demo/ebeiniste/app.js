define(['jquery', 'underscore', 'backbone', 'bootstrap', 'masonry' , 'modules/realisations'], function ($, _, Backbone, bootstrap, Masonry, realisations) {
	...
	RealisationView = new realisations.view.realisationView({collection : realisationsCollections});
